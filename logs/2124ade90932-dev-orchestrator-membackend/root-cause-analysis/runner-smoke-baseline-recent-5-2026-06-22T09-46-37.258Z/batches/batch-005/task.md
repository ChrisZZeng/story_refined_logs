...
本批次 issue 列表：
/Users/ethan/Documents/workspace/Novel/code/story_refined_logs/logs/2124ade90932-dev-orchestrator-membackend/run_logs/root-cause-analysis/runner-smoke-baseline-recent-5-2026-06-22T09-46-37.258Z/batches/batch-005/batch-issues.json

输出目录：
/Users/ethan/Documents/workspace/Novel/code/story_refined_logs/logs/2124ade90932-dev-orchestrator-membackend/run_logs/root-cause-analysis/runner-smoke-baseline-recent-5-2026-06-22T09-46-37.258Z/batches/batch-005

批次说明：
包含 high severity issue；同一 turn 的问题放在一起，避免重复读取同一轮证据。

本批次包含的 issue：
- issueIndex=14, turn=42, severity=high, type=fact-conflict, scope=visibleText：德索洛求助的核心动机在同一轮中从女儿遭受严重伤害变成伤害为假，且 pronoun 从“她”漂到“我”，破坏关键事件理解。
- issueIndex=15, turn=42, severity=medium, type=identity-drift, scope=visibleText：说话人从卡琳娜漂移到第二人称玩家，导致玩家难以判断是谁在控诉德索洛。
- issueIndex=16, turn=42, severity=medium, type=space-time-break, scope=mixed：玩家已在公寓内，当前轮却把玩家重新放到门外并要求再次进屋。
