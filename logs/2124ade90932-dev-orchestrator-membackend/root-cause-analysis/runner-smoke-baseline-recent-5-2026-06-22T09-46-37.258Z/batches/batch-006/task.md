...
本批次 issue 列表：
/Users/ethan/Documents/workspace/Novel/code/story_refined_logs/logs/2124ade90932-dev-orchestrator-membackend/run_logs/root-cause-analysis/runner-smoke-baseline-recent-5-2026-06-22T09-46-37.258Z/batches/batch-006/batch-issues.json

输出目录：
/Users/ethan/Documents/workspace/Novel/code/story_refined_logs/logs/2124ade90932-dev-orchestrator-membackend/run_logs/root-cause-analysis/runner-smoke-baseline-recent-5-2026-06-22T09-46-37.258Z/batches/batch-006

批次说明：
按 turn 顺序自动切分，控制单个 subagent 的分析负载。

本批次包含的 issue：
- issueIndex=17, turn=45, severity=low, type=quality-regression, scope=visibleText：对白和叙述边界断裂，造成局部可读性和格式质量问题。
- issueIndex=18, turn=45, severity=medium, type=unsupported-jump, scope=choices：选项让玩家追问一个从未玩家可见出现过的术语，并声称“刚才说的”。
- issueIndex=19, turn=46, severity=low, type=unsupported-jump, scope=choices：选项提前暴露未建立的事件，并且与下一轮建立的时间不一致。
- issueIndex=20, turn=48, severity=medium, type=unsupported-jump, scope=mixed：关键 NPC 姓名和搜索目标突然作为已知任务进入正文和选项。
