...
本批次 issue 列表：
/home/chris/Project_Intern/1_memorax/1_story_memory/workspace/1_evaluation_suite/story_refined_logs/logs/19daf77f335e-codex-dual-layer-memory/root-cause-analysis/runner-smoke-hybrid-recent-5-2026-06-24T04-12-51.976Z-progress-200-with-memory/batches/batch-005/batch-issues.json

输出目录：
/home/chris/Project_Intern/1_memorax/1_story_memory/workspace/1_evaluation_suite/story_refined_logs/logs/19daf77f335e-codex-dual-layer-memory/root-cause-analysis/runner-smoke-hybrid-recent-5-2026-06-24T04-12-51.976Z-progress-200-with-memory/batches/batch-005

批次说明：
包含 high severity issue；同一 turn 的问题放在一起，避免重复读取同一轮证据。

本批次包含的 issue：
- issueIndex=15, turn=54, severity=high, type=repeated-scene, scope=visibleText：重点评估段把玩家刚刚待过并离开的房间重新当成未知新地点进入，重置了空间进度和场景连续性。
- issueIndex=16, turn=54, severity=medium, type=unsupported-jump, scope=visibleText：黑猫刚被明示留在上一扇铁门边，随后无承接地出现在另一处室内，造成角色/物件位置跳跃。
